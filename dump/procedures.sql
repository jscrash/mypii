/*!50003 DROP PROCEDURE IF EXISTS `npii_alter_col` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_alter_col`(in srcdb varchar(64), in dstdb varchar(64))
begin
...
END ;;
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_create_schema` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_create_schema`(in dstdb varchar(64))
begin
    declare num_rows int default 0;
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_create_triggers` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_create_triggers`(in srcdb varchar(64), in dstdb varchar(64))
begin
declare tablename_val varchar(64);
declare schema_name varchar(64);
declare cmd_info varchar(255);
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_drop` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_drop`(in srcdb varchar(64), in dstdb varchar(64))
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_drop_all_triggers` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_drop_all_triggers`(in srcdb varchar(64))
begin
declare exit HANDLER for sqlexception
begin
    show ERRORS;
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_drop_triggers` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_drop_triggers`(in srcdb varchar(64))
begin
declare exit HANDLER for sqlexception
begin
    show ERRORS;
...
select
    concat('DROP TRIGGER IF EXISTS ',s.table_schema,'.`npii_', lower(trigger_types.t_type), '_', s.TABLE_NAME, '`;') as 'select "-- INFO: Dropping triggers" AS "-- INFO:";'
from
    npii.pii2 s
inner join
    (
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_execute` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_execute`(in `cmd` text)
    MODIFIES SQL DATA
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_get_table_cols` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_get_table_cols`(in tbl_schema varchar(32), in tbl_table varchar(64), in trg_type char(6), out tbl_columns text, out tbl_prikeys text)
begin
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_help` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_help`()
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_help_message` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_help_message`(out help_message text)
begin
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_init` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_init`(in srcdb varchar(64))
begin
    declare exit HANDLER for sqlexception
    begin
	show ERRORS;
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_load_tables` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_load_tables`(in srcdb varchar(64), in dstdb varchar(64))
begin
declare tablename_val varchar(64);
declare schema_name varchar(64);
declare cmd_info varchar(255);
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_msg_quote` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_msg_quote`(in msg varchar(255))
...
DELIMITER ;
/*!50003 DROP PROCEDURE IF EXISTS `npii_sync_table_engines` */;
DELIMITER ;;
CREATE DEFINER=`mysqlprod`@`%` PROCEDURE `npii_sync_table_engines`(in srcdb varchar(64), in dstdb varchar(64))
begin
declare num_rows int default 0;
declare tablename_val varchar(64);
declare schema_name varchar(64);
